...
describe('Merchants API Routes', () => {
	...
	const transaction1 = {amount: -100.00, fitid: '98294', date: Date.now(), note: 'Supplies', accountId: 1, categoryId: 1, merchantId: 1};

	const transaction2 = {amount: -40, fitid: '92834', date: Date.now()-1000, note: 'Other Supplies', accountId: 1, categoryId: 1, merchantId: 1};

	const transaction3 = {amount: -10, fitid: '78272', date: Date.now()-2000, note: 'Lunch', accountId: 1, categoryId: 2, merchantId: 2};
